...
public class TestHelper {
    public final static String SAMPLE_USER_NAME = "SampleUser";
    public final static String SAMPLE_USER_USERNAME = "Sample User";
    ...
    public final static UUID SAMPLE_CHEF_UUID = UUID.fromString("111e4567-e89b-12d3-a456-426614174000");

    public static ChefCreateDto sampleChefDto() {
        return new ChefCreateDto(SAMPLE_USER_UUID, SAMPLE_CHEF_PRICE, SAMPLE_CHEF_NAME);
    }

    public static UserCreateDto sampleUserDto() {
        return new UserCreateDto(SAMPLE_USER_USERNAME, SAMPLE_USER_NAME);
    }
}
