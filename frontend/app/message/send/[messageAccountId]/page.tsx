...
export default function BookingPage() {
    const params = useParams<{ messageAccountId: string }>();
    const messageAccountIdFromSlug = params.messageAccountId;
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            try {
                ...
                const res = await fetchWithAuth(`${API_BASE}/message/user/${user.userId}/message-account`, {
                    headers: {
                        "Content-Type": "application/json",
                        // Authorization header will be added by fetchWithAuth
                    },
                ...
                const text = await res.text();
                const data = text ? (JSON.parse(text) as MessageAccount | ApiError) : null;
                ...
                messageFromId = data as MessageAccount;
            ...
            const res = await fetchWithAuth(`${API_BASE}/message/send`, {
                ...
                body: JSON.stringify({
                    to: messageAccountIdFromSlug,
                    from: messageFromId.message_account_id,
                    message: sendMessage,
                }),
            });
    ...
    return (
        <div style={{ maxWidth: 560, padding: 16 }}>
            ...
            <p>
                <b>Sending To:</b> {messageAccountIdFromSlug}
            </p>
